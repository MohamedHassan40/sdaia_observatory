  ...
  return (
    <main className="p-8 grid gap-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
      ...
      {products.map((product: any) => (
        <div
          key={product.id}
          className="rounded-xl shadow-lg bg-white dark:bg-muted flex flex-col overflow-hidden transition-transform hover:scale-105 hover:shadow-2xl border border-gray-200 dark:border-gray-700"
        >
